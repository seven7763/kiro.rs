...
import { RefreshCw, LogOut, Moon, Sun, Server, Plus, Upload, FileUp, Trash2, RotateCcw, CheckCircle2, Sparkles, Settings2, Database, Scale, Network } from 'lucide-react'
        ...
        <Tabs defaultValue="overview">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button onClick={() => setGroupManagerDialogOpen(true)} size="sm" variant="outline">
